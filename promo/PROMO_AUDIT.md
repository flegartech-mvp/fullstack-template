# PROMO_AUDIT — fullstack-template
...
## Routes / screens used
- synthetic terminal frame (no GUI route)

## Run status
This project is a CLI/monorepo starter with no styled GUI home page, so its showcase uses a faithful synthetic terminal frame reproducing the real `pnpm dev` boot output. All other projects use live UI screenshots.
...
- `videos/01-instagram-reel.mp4` (4.4 MB)
- `videos/02-tiktok.mp4` (4.4 MB)
- `videos/03-youtube-short.mp4` (4.4 MB)
- `videos/04-linkedin-demo.mp4` (6.2 MB)
- `videos/05-x-demo.mp4` (4.5 MB)
- `videos/06-facebook-demo.mp4` (6.2 MB)
- `videos/07-github-readme-demo.mp4` (3.4 MB)
- `videos/08-portfolio-hero.mp4` (6.2 MB)
- `videos/gifs/github-readme-demo.gif` (4.9 MB)
- `videos/gifs/short-demo.gif` (8.1 MB)
...
**Screens/routes used:** pnpm dev boot output (terminal).
...
- [x] CLI/starter project uses a faithful terminal frame (no GUI to record)
